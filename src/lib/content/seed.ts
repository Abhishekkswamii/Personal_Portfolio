  ...
  projects: [
    {
      ...
      details: null,
      outcomes: null,
      images: { thumbnail: null, hero: null, architecture: null, gallery: [] },
    ...
    },
    {
      ...
      number: "02",
      title: "MedGuard-RAG",
      subtitle: "Safety-Aware LLM Framework for Rural Healthcare",
      category: "RAG / AI Systems",
      year: "2026",
      period: "Jan 2026 — Feb 2026",
      summary:
        "A retrieval pipeline built around refusal. Intent detection, risk triage and confidence thresholds decide when the model should answer — and when it should not.",
      technologies: ["Python", "FastAPI", "LangGraph", "ChromaDB", "Sentence Transformers", "Scikit-learn", "Pydantic"],
      highlights: [
        "Built a RAG pipeline using Sentence Transformers and ChromaDB for grounded healthcare responses.",
        "Designed a LangGraph/FastAPI flow for retrieval, intent detection, risk triage, and response generation.",
        "Added schemas, confidence thresholds, and fallback logic to reduce unsupported healthcare responses.",
      ],
      problem:
        "In a healthcare context, a fluent wrong answer is worse than no answer. A general-purpose retrieval system optimises for producing a response; this one had to be able to decline.",
      approach: [
        "Ground every response in retrieved passages via Sentence Transformers embeddings over ChromaDB.",
        "Model the flow explicitly as a LangGraph state machine — retrieval, intent detection, risk triage, generation — so each decision point is inspectable.",
        "Constrain outputs with Pydantic schemas so responses are validated structures, not free text.",
        "Gate generation behind confidence thresholds with explicit fallback paths when support is thin.",
      ],
      architecture: [
        { step: "Embed", detail: "Sentence Transformers → ChromaDB" },
        { step: "Retrieve", detail: "Semantic search over grounded corpus" },
        { step: "Classify", detail: "Intent detection · Scikit-learn" },
        { step: "Triage", detail: "Risk assessment gate" },
        { step: "Generate", detail: "Schema-validated response · Pydantic" },
        { step: "Fallback", detail: "Below threshold → decline, don’t guess" },
      ],
      details: null,
      outcomes: null,
      images: { thumbnail: null, hero: null, architecture: null, gallery: [] },
